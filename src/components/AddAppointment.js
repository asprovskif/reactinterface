...
const AddAppointment = ({onSendApointment, lastId}) => {
    const clearData = {
      ownerName: '',
      petName: '',
      aptDate: '',
    ...
    function formDataPublish() {
      ...
      onSendApointment(appointmentInfo);
            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
              ...
              <div className="mt-1 sm:mt-0 sm:col-span-2">
                <input type="text" name="ownerName" id="ownerName"
                  ...
                  className="px- py-1 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
              </div>
            </div>
            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
              ...
              <div className="mt-1 sm:mt-0 sm:col-span-2">
                ...
                value={formData.petName}
                  className="px-1 py-1 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring w-full" />
              </div>
            </div>
